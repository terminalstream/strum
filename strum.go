...
//
// If a field is tagged with TagName it assigns the indicated substring, otherwise the field is
// ignored.
//
// TagName has the format "startIdx{delimiter}endIdx" where both startIdx and endIdx are
